...
Also, users today are accustom to have user identification based in username and password.
While an early approach of username/password identification system exist, it does not contemplate the existence
...
develop a secure user identification system based in username/password keywords in
structured P2P systems, using reputation systems and groups of trusted nodes
...
secure and do not present security risks in a real environments.

The architecture to develop the system will be based in on Distributed Hash
...
designed to handle to handle remembered logins, and recovering lost passwords
...
use of preshared keys to identify the user in the network. While that can
...
\begin{enumerate}
    ...
    \item Study the P2P networks capabilities to implement complex systems as
          ...
          \emph{(October 2012 - November 2012)}
