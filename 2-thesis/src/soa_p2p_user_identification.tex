...
%An important part of password-based sign ins is the possi-
...
%hint can be stored in plaintext in the sign in information file.
...
%
% As in Section IV for the sign in procedure, we define a set of
