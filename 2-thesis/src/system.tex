...
encryption shceme for the communications between a node $A$ and $I$. This
...
in $I$ containing the new user public key and salt. If a node $I_i$ recieves at
...
\subsubsection{Lazy User's Information Store Maintenance}
...
\subsubsection{Node Failures and Node Departures}
...
crash departure situation, the noide fails silently. Pastry exchanges
...
\subsubsection{User private key recovery}
...
\subsubsection{Identified user service request}
...
% CHALLENGE, TODO: USE ONE AS EXAMPLE
% CHALLENGE, TODO: Explain challenge properties
